...
"                                <br>\n" +
"                                <input class=\"input\" type='text' name='numero' id='numero' placeholder='Numero de pagina' value='"+request.getParameter("numS")+"' />  \n" +
"                                <br>\n" +
"                                <input class=\"input\" type='text' name='NombreH' id='NombreH' value='Mango2' readonly/><br><br>  \n" +
"                            </div>\n" +
"                        </div>\n" +
